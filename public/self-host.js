  ...
  const PLATFORMS = {
    unix: {
      ...
      facts: [
        ...
        ['Sending to people', 'Link your ShareSecure account under ShareSecure account in the account menu, then type their usernames. Each person gets a copy to accept or decline.'],
      ],
    },
    windows: {
